...
In this demo, we analyze a dataset of social media posts with concept topics produced using the [concept induction algorithm](https://hci.stanford.edu/publications/2024/Lam_LLooM_CHI24.pdf).

![Texture UI](./images/lloom.png)
